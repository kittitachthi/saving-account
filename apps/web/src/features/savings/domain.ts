...
export const calculateSavingsCategories = (
  ...
  const saved = [...groups.values()].reduce(
...
export const savingsProgress = (saved: number, goal: number | null) =>
  goal && goal > 0 ? (saved / goal) * 100 : null;
